...
func CheckCoin(data models.CurrencyNotifConfig, interval string, startDate, endDate int64, close, hight, low float32) *models.BandResult {
	...
	return MakeCryptoRequestUpdateLasCandle(data, request, close, hight, low)
}
