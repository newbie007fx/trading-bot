...
func GetWeightLog(symbol string, datetime time.Time, isNoNeedDoubleCheck bool) string {
	...
	if result != nil {
		...
		if resultMid != nil {
			...
			if resultLong != nil {
				...
				if analysis.ApprovedPattern(*result, *resultMid, *resultLong, datetime, isNoNeedDoubleCheck) {
